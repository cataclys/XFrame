...
public class DragUGUI : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, IEndDragHandler
{
    ...
    void Start()
    {
        canvas = UIManager.GetCanvas().GetComponent<RectTransform>();
